...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-background to-muted pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <motion.div className="space-y-8" variants={itemVariants}>
            ...
            {/* Trust Indicators */}
            <motion.div
              className="flex flex-col sm:flex-row gap-6 py-6 border-y border-border"
              variants={itemVariants}
            >
